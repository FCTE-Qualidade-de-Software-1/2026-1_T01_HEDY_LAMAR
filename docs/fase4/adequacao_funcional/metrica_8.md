...
|---|---|---|
| Usar o registro consolidado de defeitos da M7 | Foi usado o arquivo `registro_defeitos_m7_m8.csv` | [Registro de defeitos](../../assets/dados/adequacao_funcional/registro_defeitos_m7_m8.csv) |
| Conferir severidades entre 1 e 5 | Todos os 7 defeitos possuem severidade válida | Tabela 3 desta página |
| Somar severidades | A soma das severidades foi 26 | [Resultado M7/M8](../../assets/dados/adequacao_funcional/resultado_m7_m8.csv) |
| Dividir pelo total de defeitos | Foram considerados 7 defeitos funcionais consolidados | Tabela 4 desta página |
| Aplicar régua de julgamento | Foi calculado M8 = 3,71, classificado como Insuficiente | Seções 4 e 5 desta página |
...
| AF-D04 | O sistema não apresenta semestres cursados nem estimativa de semestres restantes. | 4 |
...
O resultado de 3,71 fica acima do limite máximo satisfatório de 3,00. Portanto, a hipótese H4 definida na [Fase 2](../../fase2/01_obj_adequacao_funcional.md) **não é plenamente confirmada**, pois os defeitos não são, em média, baixos ou moderados.
...
- Reexecutar M1, M2, M3, M7 e M8 após as correções para verificar redução da média de severidade para 3,00 ou menos.
...
Os dados brutos foram obtidos conforme o método definido na Fase 3, processados por meio da média aritmética das severidades e comparados com a régua de julgamento previamente definida. A classificação final da M8 é **Insuficiente**, com severidade média **3,71**, indicando que os defeitos funcionais encontrados têm impacto médio acima do nível moderado.

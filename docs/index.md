    ...
    <tr>
      <td align="center">
        <a href="https://github.com/AndreGustavoRN" target="_blank" rel="noopener noreferrer">
          <img style="border-radius: 50%; border: 3px solid #4051B5;" src="https://github.com/AndreGustavoRN.png" width="120px;" alt="André Gustavo"/>
        </a><br />
        <sub>
          <b>
      ...
      <td align="center">
        <a href="https://github.com/BrzGab" target="_blank" rel="noopener noreferrer">
          <img style="border-radius: 50%; border: 3px solid #4051B5;" src="https://github.com/BrzGab.png" width="120px;" alt="Gabriel Lopes"/>
        </a><br />
        <sub>
          <b>
      ...
      <td align="center">
        <a href="https://github.com/GuilhermeDavila" target="_blank" rel="noopener noreferrer">
          <img style="border-radius: 50%; border: 3px solid #4051B5;" src="https://github.com/GuilhermeDavila.png" width="120px;" alt="Guilherme D Avila"/>
        </a><br />
        <sub>
          <b>
      ...
      <td align="center">
        <a href="https://github.com/lcsgborges" target="_blank" rel="noopener noreferrer">
          <img style="border-radius: 50%; border: 3px solid #4051B5;" src="https://github.com/lcsgborges.png" width="120px;" alt="Lucas Guimarães"/>
        </a><br />
        <sub>
          <b>
      ...
      <td align="center">
        <a href="https://github.com/paulocerqr" target="_blank" rel="noopener noreferrer">
          <img style="border-radius: 50%; border: 3px solid #4051B5;" src="https://github.com/paulocerqr.png" width="120px;" alt="Paulo Cerqueira"/>
        </a><br />
        <sub>
          <b>
      ...
      <td align="center">
        <a href="https://github.com/UnderwaterVillager" target="_blank" rel="noopener noreferrer">
          <img style="border-radius: 50%; border: 3px solid #4051B5;" src="https://github.com/UnderwaterVillager.png" width="120px;" alt="Vinicius de Jesus"/>
        </a><br />
        <sub>
          <b>

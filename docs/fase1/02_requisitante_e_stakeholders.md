...
A tabela abaixo torna explícita a conexão entre cada stakeholder e as decisões registradas neste relatório, atendendo ao critério de mapeamento consistente com critérios de sucesso e influência real nas escolhas.

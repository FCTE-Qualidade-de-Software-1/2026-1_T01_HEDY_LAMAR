...
| **No contexto de** | Avaliação acadêmica de qualidade de produto de software na disciplina FGA0315 — Qualidade de Software 1, com base na release [qualidade-de-software](https://github.com/lcsgborges/2025-1-NoFluxoUNB/releases/tag/qualidade-de-software) (02/06/2026), em ambiente controlado com as configurações da tabela 7. |
...
As questões foram formuladas para cobrir a subcaracterística **Adaptabilidade** da característica **Portabilidade** presentes na ISO/IEC 25010. Cada questão possui uma hipótese associada, que será confrontada com os resultados obtidos na execução da avaliação.
...
| Assistente de Inteligência Artificial (Chatbot) | interação e o retorno de sugestões |
...
*Fonte: IA com base na abordagem GQM e no objetivo de Portabilidade do No Fluxo UnB definidos nesse documento.*
...
| ENV-03 | Desktop | Linux Ubuntu 26.04 LTS (Noble Numbat) | Mozilla Firefox v148.x | 1920 × 1080 |
| ENV-04 | Desktop | macOS 16 (Sequoia) | Safari v19.x | 1440 × 900 |
| ENV-05 | Mobile | Android 13 | Google Chrome Mobile v148.0.7778.215 | 2400 x 1080 |
| ENV-06 | Mobile | Android 16 | Mozilla Firefox Mobile v148.x | 412 × 915 |
| ENV-07 | Mobile | iOS 15 (iPhone SE geração 1) | Safari Mobile v15 | 1136 x 640 |
